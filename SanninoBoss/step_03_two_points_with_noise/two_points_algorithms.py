"""Two-point cat-qubit bias optimization for step 3.
...
the no-noise and noisy two-point runs.  The noisy step still samples only
...
CACHE_ROOT = Path(tempfile.gettempdir()) / "sannino_step03_cache"
